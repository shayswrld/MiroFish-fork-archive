...
def generate_report():
    ...
    immediately. Poll progress via GET /api/report/generate/status
...
def get_report_sections(report_id: str):
    ...
    The frontend can poll this endpoint to retrieve already-generated section
    content without waiting for the entire report to complete
...
def get_console_log(report_id: str):
    ...
    Retrieve the console output (INFO, WARNING, etc.) produced during report
    generation in real time. Unlike the structured JSON log returned by the
    agent-log endpoint, this is a plain-text, console-style log.
